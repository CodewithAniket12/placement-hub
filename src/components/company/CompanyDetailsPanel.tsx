...
import { X, ExternalLink, Phone, Mail, CheckCircle2, Clock, Send } from "lucide-react";
          ...
          <div className="flex-1 overflow-y-auto p-6">
            ...
            <div className="mb-6">
              ...
              <div className="rounded-xl border border-border bg-muted/50 p-4">
                <p className="mb-3 text-base font-medium text-card-foreground">{company.hr.name}</p>
                <div className="space-y-2">
                  <a
                    href={`tel:${company.hr.phone}`}
            ...
            <div>
              ...
              <p className="text-card-foreground">{company.poc}</p>
            </div>
          </div>
